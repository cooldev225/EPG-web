...
/*
 ...
 | IMPORTANT: Based on the recommendation by many professionals, it is highly recommended to use bcrypt instead of sha1.
 | NOTE: If you use bcrypt you will need to increase your password column character limit to (80) |
 | Below there is "default_rounds" setting.  This defines how strong the encryption will be,but remember the more rounds you set the longer it will take to hash (CPU usage) So adjust this based on your server hardware. |
 ...
 | Be careful how high you set max_rounds, I would do your own testing on how long it takes to encrypt with x rounds.
 ...
 */
$config['site_title']                 = "buddywisher.com"; // Site Title, example.com
$config['admin_email']                = "bluebear1888@hotmail.com";//"kuppala85.bk@gmail.com"; // Admin Email, admin@example.com
