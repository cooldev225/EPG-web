...
class MY_Controller extends MX_Controller {
	...
	protected function render($view_file, $layout = 'default')
	{
		...
		if(isset($this->mPageTitle)&&$this->mPageTitle!="")$this->mViewData['mPageTitle']=$this->mPageTitle;
		if(!isset($this->mViewData['mPageTitle']))$this->mViewData['mPageTitle']="";
		...
		if(!isset($this->mViewData['page_title']))$this->mViewData['page_title'] = $this->mPageTitlePrefix.$this->mViewData['mPageTitle'];
